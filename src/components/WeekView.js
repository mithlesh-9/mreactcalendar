    ...
    return (
        <div>
            <div className="_heading">
                <div>
                <button onClick={()=>onPrevWeek()}><img src="https://firebasestorage.googleapis.com/v0/b/mithleshyadavcomnp.appspot.com/o/left.svg?alt=media&token=17019ae5-6b59-4c78-80f4-a2cf6d8a18ff" alt="prev" /></button>
                </div>
                    <div className="month-name" style={{fontSize:'1.8em'}}>{weekText}</div>
                <div>
                <button onClick={()=>onNextWeek()}><img src="https://firebasestorage.googleapis.com/v0/b/mithleshyadavcomnp.appspot.com/o/right.svg?alt=media&token=17d7b4e9-2304-4480-8de3-62d6ffb600b4" alt="next" /></button>
                </div>
            </div>
